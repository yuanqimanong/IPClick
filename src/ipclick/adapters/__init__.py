...
#         from .curl_cffi_adapter import is_available as curl_cffi_available
#
...
#         from .httpx_adapter import is_available as httpx_available
#
#         if httpx_available():
...
#         info[name] = {"class": adapter_class.__name__, "module": adapter_class.__module__, "available": True}
#     return info
#
#
# __all__ = [
